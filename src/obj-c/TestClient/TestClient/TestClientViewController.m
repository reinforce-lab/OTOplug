...
- (void)viewDidLoad
{
	...
	self.modem = [[[FSKModem alloc] initWithSocket:self] autorelease];
	[self.modem addObserver:self forKeyPath:@"isHeadsetInOut" options:NSKeyValueObservingOptionNew context:modem];
	self.modem.mute = YES;
